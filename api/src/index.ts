...
import { emailDomains } from './routes/email-domains.js';
import { savedSearches } from './routes/saved-searches.js';
import { kbSavedFilters } from './routes/kb-saved-filters.js';
import { kbQuality } from './routes/kb-quality.js';
import { knowledgeGaps } from './routes/knowledge-gaps.js';
...
import { knowledgeSources } from './routes/knowledge-sources.js';
...
app.route('/api/v1/email-branding', emailBranding);
app.route('/api/v1/email-domains', emailDomains);
app.route('/api/v1/saved-searches', savedSearches);
app.route('/api/v1/kb-saved-filters', kbSavedFilters);
app.route('/api/v1/kb-quality', kbQuality);
app.route('/api/v1/knowledge-gaps', knowledgeGaps);
