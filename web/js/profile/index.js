    ...
    <div class="page">
      ...
      <div class="page-scroll">
        ...
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:10px;margin-top:16px">
          <div class="r-tile" style="border-color:var(--cyan-bd);background:var(--cyan-lt)"><div class="r-tile-n" style="color:var(--cyan)">${open.length}</div><div class="r-tile-l" style="color:var(--cyan)">Open</div></div>
          <div class="r-tile" style="border-color:var(--green-bd);background:var(--green-lt)"><div class="r-tile-n" style="color:var(--green)">${resolved.length}</div><div class="r-tile-l" style="color:var(--green)">Resolved</div></div>
          <div class="r-tile" style="border-color:var(--amber-bd);background:var(--amber-lt)"><div class="r-tile-n" style="color:var(--amber)">${csatRated.length?avgCSAT.toFixed(1):'—'}</div><div class="r-tile-l" style="color:var(--amber)">Avg CSAT (${csatRated.length})</div></div>
