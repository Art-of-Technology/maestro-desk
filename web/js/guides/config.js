export const GUIDE_STEPS = [
  ...
  },
  {
    ...
    instructions: [
      'Open the ticket and choose Reply. Use Internal note only for information intended for colleagues; check the selected tab before writing.',
      ...
      'Check the customer language and the “Send replies in customer language” setting. If translation is enabled, the outgoing reply may differ from the wording in your editor.',
  ...
  },
  {
    ...
    instructions: [
      'In the Reply composer, choose Macros to open “Insert canned response”, then select a response. Read the “Preview response” window before choosing Insert response.',
      ...
      'Insert ▾ in the composer offers Customer name, Ticket ID, Brand and Agent name at the cursor. These insert available values directly; typing a token yourself does not automatically fill it. Replies containing unfilled placeholders are blocked.',
  ...
  },
  {
    ...
    instructions: [
      'Use AI ▾ → Draft reply, or Similar replies when available. AI ▾ also offers writing changes such as Shorten and Improve writing. These prepare text for you to review.',
      ...
      'Choose References to inspect supporting articles or previous replies, including dates, markets and warnings. No references means you must verify claims yourself. References and internal review notes are not sent to the customer.',
