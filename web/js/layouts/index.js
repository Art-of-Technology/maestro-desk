...
const FIELD_LAYOUTS = {
  ...
  customer: [
    ...
    { key:'maestroUserId', label:'Member ID', locked:false, required:false, visible:true, requiredNA:true, note:'linked automatically from Maestro' },
    { key:'memberId',      label:'Global ID',       locked:false, required:false, visible:true, requiredNA:true, note:'linked automatically from Maestro' },
