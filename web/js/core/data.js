...
export const KB_ARTICLES = [
  ...
  {id:'KB-005', title:'Setting up the Claude API key for AI Draft', category:'Getting Started', author:'Emma Clarke', updated:'2025-04-15',
   body:`The "AI Draft" button uses your workspace AI connection to draft a reply from the conversation.\n\nGo to Settings → AI Assistant to choose your model, view workspace credit and check the connection. Your platform administrator manages the server key and workspace credit.\n\nAI requests go through the Respovia server. Player account details are excluded by default; workspace admins can change this setting. Ticket text may still contain personal data.`},
