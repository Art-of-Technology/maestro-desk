...
function dashSLA(s) {
  ...
  const tilesBody = `
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-top:6px">
      <div class="r-tile" style="border-color:var(--green-bd);background:var(--green-lt);padding:10px"><div class="r-tile-n" style="color:var(--green);font-size:20px">${s.slaOk}</div><div class="r-tile-l" style="color:var(--green);font-size:10px">On track</div></div>
      <div class="r-tile" style="border-color:var(--amber-bd);background:var(--amber-lt);padding:10px"><div class="r-tile-n" style="color:var(--amber);font-size:20px">${s.slaWarn}</div><div class="r-tile-l" style="color:var(--amber);font-size:10px">Warning</div></div>
      <div class="r-tile" style="border-color:var(--red-bd);background:var(--red-lt);padding:10px"><div class="r-tile-n" style="color:var(--red);font-size:20px">${s.slaBreach}</div><div class="r-tile-l" style="color:var(--red);font-size:10px">Breach</div></div>
    </div>`;
  ...
  return `
    <div class="card span-4">
      ...
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-top:8px">
        <div class="r-tile" style="padding:10px;border-color:var(--cyan-bd);background:var(--cyan-lt)"><div class="r-tile-n" style="color:var(--cyan);font-size:20px">${created}</div><div class="r-tile-l" style="color:var(--cyan);font-size:9px">Touched</div></div>
        <div class="r-tile" style="padding:10px;border-color:var(--green-bd);background:var(--green-lt)"><div class="r-tile-n" style="color:var(--green);font-size:20px">${resolved}</div><div class="r-tile-l" style="color:var(--green);font-size:9px">Resolved</div></div>
