...
export function renderSLABreach() {
  ...
  return shell(`
    ...
    <div class="page-scroll">
      ${SB.truncated ? `<div style="margin-bottom:14px;padding:8px 12px;border:1px solid var(--amber-bd);background:var(--amber-lt);border-radius:var(--r);font-size:12px;color:var(--amber)">Large range: only the newest 5,000 tickets are included — these numbers are partial. Narrow the date range for full coverage.</div>` : ''}
